...
### Defining a function to calculate the Cramer V and Phi in R


#print.noquote("Cramer V measure of effect size (Phi for 2 X 2 tables).")
...
# ------------------------------------------------------------------#
      ...
      # get the results
      res <- list(input.name, nd = nd, test = test, CV = CV, ES = ES)
